...
function RegisterForm({previousStep}:propType) {
  ...
  <motion.form className='flex flex-col gap-5 w-full max-w-sm'
     ...
     <div className='relative '>
      ...
      <input  type="email" placeholder='Enter Email' className="w-full border border-gray-300 rounded-xl
        py-3 pl-10 pr-4 text-gray-800 
        focus:ring-2 focus:ring-green-500 focus:outline-none"   
    ...
    <p  className='text-gray-600 mt-6 text-sm flex items-center gap-1 cursor-pointer'>Already have an account ? 
